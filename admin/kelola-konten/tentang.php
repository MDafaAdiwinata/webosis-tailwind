...
if (isset($_POST['update_data'])) {
    ...
    if (!empty($gambar_baru)) {
        ...
        if (!in_array($ekstensi, $ekstensi_valid)) {
            ...
            <span class="sr-only">Info</span>
                <div class="ms-3 me-4 text-sm md:text-md font-medium">
                    Format file tidak diizinkan! Gunakan JPG, JPEG, atau PNG.
                </div>
        ...
        if (move_uploaded_file($tmp, $pathBaru)) {
            ...
            <span class="sr-only">Info</span>
                <div class="ms-3 me-4 text-sm md:text-md font-medium">
                    Data berhasil diperbarui dengan gambar baru!
                </div>
            ...
            <span class="sr-only">Info</span>
                <div class="ms-3 me-4 text-sm md:text-md font-medium">
                    Gagal upload file ke folder tujuan!
                </div>
            <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-[var(--bg-danger)]/30 text-[var(--text-danger)] rounded-lg cursor-pointer focus:ring-2 p-1.5 transition duration-300 border border-[var(--bg-danger)] inline-flex items-center justify-center h-8 w-8" data-dismiss-target="#alert-2" aria-label="Close">
                <span class="sr-only">Close</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
        ...
        $query = "UPDATE tb_about 
                  SET hashtag_about='$hashtag', deskripsi_about='$deskripsi' 
                  WHERE id_about='$id_about'";
        mysqli_query($koneksi, $query);
    ...
    <div class="px-4 md:px-4 lg:px-8 sm:ml-64">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div
                ...
                <img src="../../assets/img/<?= $tampilTentang['img_about']; ?>" class="w-full rounded-md" alt="Img About">
                        ...
                        <div class="relative bg-[var(--txt-primary)] rounded-xl shadow-sm">
                            ...
                            <div class="p-4 md:p-5">
                                <form class="space-y-4" action="" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="id_about" value="<?= $tampilTentang['id_about']; ?>">
                                    <input type="hidden" name="gambar_lama" value="<?= $tampilTentang['img_about']; ?>">
                                    <div class="mb-6">
                                        ...
                                        <input
                                            ...
                                            id="file_input" type="file" accept=".jpg, .png, .jpeg" name="img_about">
                                    </div>
                                    <div class="mb-6">
                                        <label for="text"
                                        ...
                                        <input type="text" name="hashtag_about" id="text"
                                            ...
                                            value="<?= $tampilTentang['hashtag_about'] ?>" required />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="deskripsiTentang" rows="4" name="deskripsi_about"
                                            class="bg-transparent border border-[var(--bg-primary)]/50 text-[var(--txt-primary2)] text-md rounded-xl focus:ring-[var(--txt-primary2)]/80 focus:border-[var(--txt-primary2)]/80 block w-full p-2.5"><?= $tampilTentang['deskripsi_about']; ?></textarea>
                                    </div>
