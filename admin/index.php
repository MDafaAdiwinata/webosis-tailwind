...
if (isset($_POST['login'])) {
    ...
    if ($username == "" || $password == "") {
        ...
        $sql = mysqli_query($koneksi, "SELECT * FROM admin WHERE BINARY username = '$username_secure'");
...
<head>
    ...
    <title>Login Admin - Web Osis</title>
            ...
            <form class="max-w-md mx-auto bg-white/90 p-6 md:p-8 rounded-2xl" method="POST" action="">
                <div class="mx-auto text-center">
                    ...
                    <h1 class="text-[var(--txt-primary2)] text-md sm:text-lg md:text-xl mb-4">
                        Silahkan Login Untuk <br> Menggunakan Website Osis
                    </h1>
                </div>
                <div class="my-6">
