...
// Panggil Data
$ambilBiyouth = mysqli_query($koneksi, "SELECT * FROM tb_biyouth WHERE id_biyouth='$_GET[kode]'");
$tampilBiyouth = mysqli_fetch_array($ambilBiyouth);
...
if (isset($_POST['ubah'])) {
    ...
    $gambar_baru = $_FILES['img_biyouth_update']['name'];
    $tmp = $_FILES['img_biyouth_update']['tmp_name'];
    $ukuran = $_FILES['img_biyouth_update']['size'];
    $error = $_FILES['img_biyouth_update']['error'];
    ...
    if (!empty($gambar_baru) && $error === 0) {
        ...
        if (!in_array($ekstensi, $ekstensi_valid)) {
            ...
            header("Location: ubah-biyouth.php?kode=$id_biyouth");
            exit;
        }
        ...
        if (move_uploaded_file($tmp, $pathBaru)) {
            ...
            $query = "UPDATE tb_biyouth SET 
                      judul_biyouth='$judul', 
                      nama_peserta='$peserta', 
                      gambar_biyouth='$newName'
                      WHERE id_biyouth='$id_biyouth'";
            ...
            <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-[var(--bg-success)]/30 text-[var(--text-success)] rounded-lg cursor-pointer focus:ring-2 p-1.5 transition duration-300 border border-[var(--bg-success)] inline-flex items-center justify-center h-8 w-8" data-dismiss-target="#alert-2" aria-label="Close">
                ...
                header("Location: ../interaksi/biyouth.php");
                exit;
            } else {
            ...
            header("Location: ubah-biyouth.php");
            exit;
        }
    } else {
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex w-full items-center justify-center mt-4">
                <form class="space-y-4 w-full lg:w-2/5 mb-32" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id_biyouth" value="<?= $tampilBiyouth['id_biyouth']; ?>">
                    <input type="hidden" name="gambar_lama" value="<?= $tampilBiyouth['gambar_biyouth']; ?>">
                    <div class="mb-6">
                        <?php echo $alert_message; ?>
                    </div>
                    <div class="mb-6">
                        <small class="block text-sm text-[var(--txt-primary2)]">Gambar saat ini:
                            <?= $tampilBiyouth['gambar_biyouth']; ?>
                        </small>
                        <?php if (!empty($tampilBiyouth['gambar_biyouth']) && file_exists("../../assets/img/biyouth_creation/" . $tampilBiyouth['gambar_biyouth'])): ?>
                            <img src="../../assets/img/biyouth_creation/<?= $tampilBiyouth['gambar_biyouth']; ?>" alt="Preview Gambar" width="300"
                                class="mt-2 img-thumbnail d-block">
                        <?php endif; ?>
                    </div>
                    <div class="mb-6">
                        <label class="block mb-2 text-lg font-normal text-[var(--txt-primary2)]"
                            for="img_biyouth_update">
                        ...
                        <input
                            ...
                            id="img_biyouth_update" type="file" accept=".jpg, .png, .jpeg" name="img_biyouth_update">
                    </div>
                    <div class="mb-6">
                        <label for="judul_biyotuh"
                            class="block mb-2 text-lg font-normal text-[var(--txt-primary2)]">
                            Judul Karya/Biyouth
                        </label>
                        <input type="text" name="judul_biyouth" id="judul_biyotuh" value="<?php echo $tampilBiyouth['judul_biyouth'] ?>"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="nama_peserta" id="nama_peserta" value="<?php echo $tampilBiyouth['nama_peserta'] ?>"
                            class="bg-transparent border border-[var(--bg-primary)]/50 text-[var(--txt-primary2)] text-md rounded-xl focus:ring-[var(--txt-primary2)]/80 focus:border-[var(--txt-primary2)]/80 block w-full p-2.5" required />
                    </div>
