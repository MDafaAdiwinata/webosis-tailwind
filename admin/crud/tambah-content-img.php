...
if (isset($_POST['tambah'])) {
    ...
    $gambar = $_FILES['img_content']['name'];
    $tmp = $_FILES['img_content']['tmp_name'];
    $ukuran_gambar = $_FILES['img_content']['size'];
    ...
    if (!in_array($ext, $tipe_valid)) {
        ...
        header("Location: tambah-content-img.php");
        exit;
    }
    ...
    move_uploaded_file($tmp, "../../assets/img/galeri/" . $nama_gambar_baru);

    mysqli_query($koneksi, "INSERT INTO tb_main_content_img SET
          img_content = '$nama_gambar_baru',
          nama_img = '$nama_img'
      ");
...
<head>
    ...
    <title>Main Content Img - Admin Dashboard</title>
                ...
                <form class="space-y-4 w-full lg:w-2/5" action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="img_content" type="file" accept=".jpg, .png, .jpeg" name="img_content" required>
                    </div>
                    <div class="mb-6">
                        <label for="nama_img"
                        ...
                        <input type="text" name="nama_img" id="nama_img"
