...
if (isset($_POST['tambah'])) {
    ...
    $nama_divisi = mysqli_real_escape_string($koneksi, $_POST['tagline_divisi']);

    $gambar = $_FILES['img_divisi']['name'];
    $tmp = $_FILES['img_divisi']['tmp_name'];
    $ukuran_gambar = $_FILES['img_divisi']['size'];
    ...
    if (!in_array($ext, $tipe_valid)) {
        ...
        header("Location: tambah-divisi.php");
        exit;
    }
    ...
    move_uploaded_file($tmp, "../../assets/img/divisi/" . $nama_gambar_baru);

    mysqli_query($koneksi, "INSERT INTO tb_divisi SET
          img_divisi = '$nama_gambar_baru',
          tagline_divisi = '$nama_divisi'
      ");
                ...
                <form class="space-y-4 w-full lg:w-2/5" action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="img_divisi" type="file" accept=".jpg, .png, .jpeg" name="img_divisi" required>
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="text" name="tagline_divisi" id="tagline_divisi"
