...
if (isset($_POST['ubah'])) {
    ...
    $gambar_baru = $_FILES['img_news_update']['name'];
    $tmp = $_FILES['img_news_update']['tmp_name'];
    $ukuran = $_FILES['img_news_update']['size'];
    $error = $_FILES['img_news_update']['error'];
            ...
            <div class="flex w-full items-center justify-center mt-4">
                <form class="space-y-4 w-full lg:w-2/5 mb-32" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <?php if (!empty($tampilNews['gambar']) && file_exists("../../assets/img/news/" . $tampilNews['gambar'])): ?>
                            <img src="../../assets/img/news/<?= $tampilNews['gambar']; ?>" alt="Preview Gambar" width=""
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="img_news_update" type="file" accept=".jpg, .png, .jpeg" name="img_news_update">
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="text" name="judul_news" id="judul_news" value="<?php echo $tampilNews['judul_news'] ?>"
                    ...
                    <div>
                        ...
                        <textarea id="deskripsiNews" rows="4" name="deskripsi_news"
                            class="bg-transparent border border-[var(--bg-primary)]/50 text-[var(--txt-primary2)] text-md rounded-xl focus:ring-[var(--txt-primary2)]/80 focus:border-[var(--txt-primary2)]/80 block w-full p-2.5"><?php echo $tampilNews['deskripsi_news'] ?></textarea>
                    </div>
