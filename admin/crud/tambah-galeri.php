...
if (isset($_POST['tambah'])) {
    ...
    $gambar = $_FILES['img_galeri']['name'];
    $tmp = $_FILES['img_galeri']['tmp_name'];
    $ukuran_gambar = $_FILES['img_galeri']['size'];
    ...
    mysqli_query($koneksi, "INSERT INTO tb_galeri SET
          img_galeri = '$nama_gambar_baru',
                ...
                <form class="space-y-4 w-full lg:w-2/5" action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="img_galeri" type="file" accept=".jpg, .png, .jpeg" name="img_galeri" required>
                    </div>
                    <div class="mb-6">
                        <label for="kategori"
