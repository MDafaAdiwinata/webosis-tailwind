...
if (isset($_POST['tambah'])) {
    ...
    $judul_card = mysqli_real_escape_string($koneksi, $_POST['judul_card']);
    ...
    $img_card = $_FILES['img_card']['name'];
    $tmp = $_FILES['img_card']['tmp_name'];
    $ukuran_gambar = $_FILES['img_card']['size'];

    // Lokasi folder tujuan
    $folder = "../../assets/img/promdat/";
    $newName = time() . '-' . $img_card;
    $pathBaru = $folder . $newName;

    // Ekstensi yang diperbolehkan
    $ekstensi_valid = ['jpg', 'jpeg', 'png'];
    $ekstensi = strtolower(pathinfo($img_card, PATHINFO_EXTENSION));
    ...
    if (!in_array($ekstensi, $ekstensi_valid)) {
        ...
        header("Location: tambah-program.php");
        exit;
    }
    ...
    if (move_uploaded_file($tmp, $pathBaru)) {
        ...
        mysqli_query($koneksi, "INSERT INTO tb_promdat SET
        img_card = '$newName',
        judul_card = '$judul_card',
                ...
                <form class="space-y-4 w-full lg:w-2/5" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="file_input" type="file" accept=".jpg, .png, .jpeg" name="img_card" required>
                    </div>
                    <div class="mb-6">
                        ...
                        <input type="text" name="judul_card" id="judul_card"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="tanggal_card" id="tanggal_card"
                            class="bg-transparent border border-[var(--bg-primary)]/50 text-[var(--txt-primary2)] text-md rounded-xl focus:ring-[var(--txt-primary2)]/80 focus:border-[var(--txt-primary2)]/80 block w-full p-2.5" required />
                    </div>
                    <div class="mb-6">
                        <label for="kategori"
                        ...
                        <select id="kategori" name="kategori"
                            ...
                            <option value="Minat dan Bakat">Minat & Bakat</option>
